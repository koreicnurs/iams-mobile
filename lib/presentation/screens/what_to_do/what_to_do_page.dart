...
@RoutePage()
class WhatToDoPage extends StatefulWidget {
  const WhatToDoPage({super.key});

  @override
  State<WhatToDoPage> createState() => _WhatToDoPageState();
}

class _WhatToDoPageState extends State<WhatToDoPage> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const TitleWidget(
            title: 'Правила поведения в чрезвычайных ситуациях',
          ),
          Expanded(
              ...
              builder: (context, state) {
                if (state is GuidesLoading) {
                  ...
                  final guides = state.guides
                      .where((guide) => guide.category.toString() == "2")
                      .toList();
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  WhatToDoDetailPage(guide: guide),
                            ),
                          );
                        },
                        child: Container(
